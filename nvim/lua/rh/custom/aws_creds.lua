-- ~/.config/nvim/lua/rh/custom/aws_creds.lua
--
...
--
-- Bound to <leader>ap in lua/rh/core/keymaps.lua.
-- Moved from lua/custom/ to lua/rh/custom/ so everything of yours lives under
-- the rh namespace; the code itself is unchanged.
